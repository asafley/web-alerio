<!-- resources/views/admin/services/editor.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container py-5">
            ...
            <div id="loading-indicator" class="card shadow-sm mb-4" style="display: none;">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-0">Loading services data...</p>
                </div>
            </div>

            <!-- Form for Uservice Editor -->
            <form id="services-form" class="card shadow-sm">
                <div class="card-body">
                    <!-- Headline URI -->
                    <div class="mb-4">
...
`                   <!-- Post Subtitle -->
                    ...
                    <div class="d-flex gap-2 pt-3 border-top">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Save Uservice
                        </button>
                        <button type="reset" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-clockwise me-2"></i>Reset
                        </button>
                        <a href="{{ route('admin.services') }}" class="btn btn-outline-secondary ms-auto">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (postId !== 'null') {
                        ...
                        fetch(`/api/v1/admin/services/${postId}`, {
                            headers: {
                    ...
                    $('#services-form').on('submit', async function(e) {
                        if (${module}Id === 'null') {
                            e.preventDefault();
                            ...
                            try {
                                ...
                                // Send JSON request
                                const response = await fetch(`/api/v1/admin/services/${postId}`, {
                                    method: 'PUT',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'Accept': 'application/json',
