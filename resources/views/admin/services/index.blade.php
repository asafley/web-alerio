...
<html lang="en">
<head>
    @include('partials.head', ['title' => 'Uservices Management - Admin'])
</head>
<body class="bg-light">
<div id="app">
    <div class="container py-5">
        <div class="mb-4 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.services.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-2"></i>New Uservice
            </a>
        </div>
        ...
        <script>
            async function loadUservices() {
                try {
                    ...
                    if (posts.length === 0) {
                        tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted"><div class="py-4"><p>No services found</p><a href="/admin/services/create" class="btn btn-sm btn-primary">Add Post</a></div></td></tr>';
                        return;
                    }
                    ...
                    posts.forEach(function(post, index, array) {
                        ...
                        row.innerHTML = `
                            ...
                            <td>
                                <a href="/admin/services/edit/${post.id}" class="btn btn-sm btn-primary">Edit</a>
                                <button class="btn btn-sm btn-danger" onclick="deleteUservice(${post.id})">Delete</button>
                                <form id="delete-${post.id}" action="/admin/services/${post.id}" method="POST" style="display: none;">
            ...
            function deleteUservice(postId) {
            ...
            document.addEventListener('DOMContentLoaded', loadUservices);
        </script>
    </div>
