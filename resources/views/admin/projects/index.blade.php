    ...
    <div class="container py-5">
        <div class="mb-4 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.projects.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-2"></i>New Uproject
            </a>
        </div>
        ...
        <script>
            async function loadUprojects() {
                try {
                    ...
                    if (posts.length === 0) {
                        tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted"><div class="py-4"><p>No projects found</p><a href="/admin/projects/create" class="btn btn-sm btn-primary">Add Post</a></div></td></tr>';
                        return;
                    }
                    ...
                    posts.forEach(function(post, index, array) {
                        ...
                        row.innerHTML = `
                            ...
                            <td>
                                <a href="/admin/projects/edit/${post.id}" class="btn btn-sm btn-primary">Edit</a>
                                <button class="btn btn-sm btn-danger" onclick="deleteUproject(${post.id})">Delete</button>
                                <form id="delete-${post.id}" action="/admin/projects/${post.id}" method="POST" style="display: none;">
            ...
            function deleteUproject(postId) {
            ...
            document.addEventListener('DOMContentLoaded', loadUprojects);
        </script>
    </div>
