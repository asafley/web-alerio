<!-- resources/views/admin/users/editor.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    @include('partials.head', ['title' => 'Uuser Editor - Admin'])
</head>
<body class="bg-light">
    <div id="app">
        <div class="container py-5">
            ...
            <div id="loading-indicator" class="card shadow-sm mb-4" style="display: none;">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-0">Loading users data...</p>
                </div>
            </div>

            <!-- Form for Uuser Editor -->
            <form id="users-form" class="card shadow-sm">
                <div class="card-body">
                    <!-- Headline URI -->
                    <div class="mb-4">
...
`                   <!-- Post Subtitle -->
                    ...
                    <div class="d-flex gap-2 pt-3 border-top">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Save Uuser
                        </button>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (postId !== 'null') {
                        ...
                        fetch(`/api/v1/admin/users/${postId}`, {
                            headers: {
                    ...
                    $('#users-form').on('submit', async function(e) {
                        if (${module}Id === 'null') {
                            e.preventDefault();
                            ...
                            try {
                                ...
                                // Send JSON request
                                const response = await fetch(`/api/v1/admin/users/${postId}`, {
                                    method: 'PUT',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'Accept': 'application/json',
